...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://root:@localhost/electromart?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://root:@localhost/electromart?new_link=true');
  }
}
...
$civicrm_root = 'C:\xampp\htdocs\arduinoOnlineMarket\administrator\components\com_civicrm\civicrm';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', 'C:\xampp\htdocs\arduinoOnlineMarket\media\civicrm\templates_c');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'http://localhost/arduinoOnlineMarket/administrator/');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', '38116ae647ff0373d25d5e22bf484528');
}
...
// define( 'CIVICRM_MAIL_LOG', 'C:\xampp\htdocs\arduinoOnlineMarket\media\civicrm\templates_c/mail.log');
// }
