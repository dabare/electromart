...
$document->addScript(rtrim(JURI::base(),'/').'/../media/com_securitycheck/javascript/bootstrap-modal.js');
...
<div class="securitycheck-bootstrap">
	...
	<table id="report" width="100%">
        ...
        <tr>
			<td colspan="5">
                <ul>	
					...
					<li style="margin-top: 10px;">
						<strong><?php echo JText::_( 'COM_SECURITYCHECKPRO_SECURITY_MALWARE_FOUND' ); ?></strong>
						<br/>
						<div class="securitycheck-bootstrap">
							<?php 
								echo "<span class=\"label label-info\">" . JText::_('COM_SECURITYCHECK_AVAILABLE_ONLY_PRO_VERSIONS') . "</span>";
							?>
						...
						<div class="securitycheck-bootstrap">
							<?php 														
								if ( $this->system_info['files_with_bad_integrity'] == 0 ) {
									echo "<span class=\"label label-success\">OK</span>";
								} else if ( $this->system_info['files_with_bad_integrity'] == -1 ) {			
									echo "<span class=\"label label-info\">" . JText::_('COM_SECURITYCHECK_AVAILABLE_ONLY_PRO_VERSIONS') . "</span>";							
							?>
								...
								<div class="securitycheck-bootstrap">
									<?php 
										if ( !$this->system_info['firewall_plugin_enabled'] ) {	
											...
											echo "<span class=\"label label-important\">" . JText::sprintf( 'COM_SECURITYCHECKPRO_SECURITY_PROBLEM_FOUND',1 ) . "</span>";
									?>
										<button class="btn btn-info btn-mini" type="button" onclick="Joomla.submitbutton('GoToFirewalExceptions')" href="#"><i class="icon-wrench icon-white"></i></button>
							...
							<li style="margin-top: 10px;">
								...
								<div class="securitycheck-bootstrap">
									<?php 
										if ( !$this->system_info['firewall_plugin_enabled'] ) {	
											echo "<span class=\"label label-warning\">" . JText::_( 'COM_SECURITYCHECKPRO_ENABLE_FIREWALL_TO_APPLY') . "</span>";
										} else if ( $this->system_info['firewall_options']['session_protection_active'] ) {
											echo "<span class=\"label label-success\">OK</span>";
										} else {
											echo "<span class=\"label label-important\">" . JText::sprintf( 'COM_SECURITYCHECKPRO_SECURITY_PROBLEM_FOUND',1 ) . "</span>";
									?>
		...
		<tr>
            <td><h5><?php echo JText::_( 'COM_SECURITYCHECK_GLOBAL_CONFIGURATION' ); ?></h5></td>
            <td></td>
            <td></td>
            <td></td>
            <td><div class="arrow"></div></td>
        ...
        <tr>
            <td colspan="5">
                <ul>
					<li>
						<strong><?php echo JText::_( 'COM_SECURITYCHECK_SYSINFO_JOOMLAVERSION' ); ?></strong>
						<br/>
						<?php echo $this->system_info['version']; ?>											
					</li>                    					
					<li style="margin-top: 10px;">
						<strong><?php echo JText::_( 'COM_SECURITYCHECK_SYSINFO_JOOMLAPLATFORM' ); ?></strong>
						<br/>
		...
		<tr>
            <td><h5><?php echo JText::_( 'COM_SECURITYCHECK_MYSQL_CONFIGURATION' ); ?></h5></td>
            <td></td>
            <td></td>
            <td></td>
            <td><div class="arrow"></div></td>
        ...
        <tr>
            <td colspan="5">
                <ul>				
                    <li>
						<strong><?php echo JText::_( 'COM_SECURITYCHECK_SYSINFO_MAX_ALLOWED_PACKET' ); ?></strong>
						<br/>
		...
		<tr>
            <td><h5><?php echo JText::_( 'COM_SECURITYCHECK_PHP_CONFIGURATION' ); ?></h5></td>
            <td></td>
            <td></td>
            <td></td>
            <td><div class="arrow"></div></td>
        ...
        <tr>
            <td colspan="5">
                <ul>
					<li>
						<strong><?php echo JText::_( 'COM_SECURITYCHECK_SYSINFO_PHPVERSION' ); ?></strong>
						<br/>
						<?php echo $this->system_info['phpversion']; ?>											
					</li>                    					
					<li style="margin-top: 10px;">
						<strong><?php echo JText::_( 'COM_SECURITYCHECK_SYSINFO_MEMORY_LIMIT' ); ?></strong>
						<br/>
...
<style type="text/css">
        ...
        #report th { background:#7CB8E2 url(/media/com_securitycheck/images/header_bkg.png) repeat-x scroll center left; color:#fff; padding:7px 15px; text-align:left;}
        #report td { background:#C7DDEE none repeat-x scroll center left; color:#000; padding:7px 15px; }
        #report tr.odd td { background:#fff url(/media/com_securitycheck/images/row_bkg.png) repeat-x scroll center left; cursor:pointer; }
        #report div.arrow { background:transparent url(/media/com_securitycheck/images/arrows.png) no-repeat scroll 0px -16px; width:16px; height:16px; display:block;}
